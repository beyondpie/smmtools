...
RcppExport SEXP _smmtools_tabulate2dCpp(SEXP xSEXP, SEXP xminSEXP, SEXP xmaxSEXP, SEXP ySEXP, SEXP yminSEXP, SEXP ymaxSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_smmtools_tabulate2dCpp", (DL_FUNC) &_smmtools_tabulate2dCpp, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_smmtools(DllInfo *dll) {
